-- Create the missing user and transfer mock chirps
-- This script will create the user and add the mock chirps

-- First, create the mock user (Kriselle) in the database
...
SELECT 'User and mock chirps created successfully!' as status;
SELECT COUNT(*) as total_chirps FROM chirps;
SELECT COUNT(*) as total_users FROM users;
SELECT id, email, first_name, handle FROM users WHERE id = '123e4567-e89b-12d3-a456-426614174000';
